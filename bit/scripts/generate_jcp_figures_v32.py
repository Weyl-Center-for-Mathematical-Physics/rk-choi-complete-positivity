...
DATA = ROOT / "results" / "jcp_figures_v32"
VERIFY = ROOT / "results" / "v27" / "v27_verification.json"
VERIFY31 = ROOT / "results" / "v32" / "v32_verification.json"
...
PDF_META = {
    "Title": "Candidate-map complete-positivity figures, v3.2",
    "Author": "G. Blake Pierpoint, Olivier Bernard, Yichen Liu",
    "Creator": "generate_jcp_figures_v32.py",
    "CreationDate": FIXED_DATE,
    "ModDate": FIXED_DATE,
}
PNG_META = {"Software": "generate_jcp_figures_v32.py", "Creation Time": "2026-08-14T00:00:00Z"}
...
if __name__ == "__main__":
    ...
    graphical_abstract()
    plt.close("all")
    print("Generated v3.2 JCP figures, graphical abstract, and source data.", flush=True)
