...
with (OUT / "adaptive_benchmark_v30.csv").open("w", newline="", encoding="utf-8") as handle:
...
(OUT / "v30_verification.json").write_text(json.dumps(payload, indent=2), encoding="utf-8")

md = [
    "# v3.0 candidate-map verification",
    "",
...
(OUT / "v30_verification.md").write_text("\n".join(md) + "\n", encoding="utf-8")
