...
"""Second-order adversarial regression suite for JCP v3.1.
...
OUT = ROOT / "independent_validation" / "second_order_adversarial_v31_report.json"
...
current_script = (ROOT / "scripts" / "verify_v31_extensions.py").read_text(encoding="utf-8")
add("current verifier writes v31", 'results" / "v31"' in current_script and "adaptive_benchmark_v31.csv" in current_script)
...
print(f"Second-order adversarial v3.1: {report['passed']}/{report['total']} checks passed.")
print(f"Wrote {OUT}")
