...
OUT = ROOT / "independent_validation" / "independent_audit_v27_report.json"
...
def main():
    ...
    print(f"Independent audit: {report['passed']}/{report['total']} checks passed; 15000 randomized mismatches={mismatches}.")
    print(f"Wrote {OUT}")
