...
"""Standalone analytic and direct-Choi audit for v3.1.
...
OUT = ROOT / "independent_validation" / "independent_audit_v31_report.json"
...
def main():
    ...
    print(f"Independent audit v3.1: {report['passed']}/{report['total']} checks passed; 15000 randomized mismatches={mismatches}.")
    print(f"Wrote {OUT}")
