...
"""Independent package-level v3.1 executed-candidate contract checks."""
...
OUT = ROOT / "independent_validation" / "executed_candidate_contract_v31_report.json"
...
print(f"Executed-candidate contract v3.1: {report['passed']}/{report['total']} checks passed.")
print(f"Wrote {OUT}")
