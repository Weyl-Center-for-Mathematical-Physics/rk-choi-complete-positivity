...
"""Standalone analytic and direct-Choi audit for v2.9.
...
OUT = ROOT / "independent_validation" / "independent_audit_v29_report.json"
...
def main():
    ...
    print(f"Independent audit v2.9: {report['passed']}/{report['total']} checks passed; 15000 randomized mismatches={mismatches}.")
    print(f"Wrote {OUT}")
