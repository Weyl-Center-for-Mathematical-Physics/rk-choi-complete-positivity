...
## Adaptive evidence
- boundary guard/fallback action totals: `{'accepted_steps': 15, 'direct_accepts': 0, 'projected_accepts': 0, 'rotating_accepts': 15, 'strang_accepts': 0, 'exact_fallback_accepts': 0, 'locator_calls': 15, 'successful_projections': 0, 'empty_component_outcomes': 15, 'uncertain_outcomes': 0, 'root_isolation_ops': 45, 'certification_ops': 117, 'binary_recertifications': 0, 'precision_escalations': 0, 'fallback_events': 15, 'rhs_stage_evaluations': 468, 'exponential_actions': 0}`
- buffered useful case: direct=3, projected=2, error=0.0002853084392581392
- near-saddle useful case: projected=1, locator calls=1, error=0.00021027592790007218
